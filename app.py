...
def create_app(config_name=None):
    ...
    # Only set SERVER_NAME if explicitly provided via environment variable
    # This prevents Flask warnings when the actual server name differs
    if os.environ.get('SERVER_NAME'):
        app.config['SERVER_NAME'] = os.environ.get('SERVER_NAME')

    # Set URL scheme for email links
